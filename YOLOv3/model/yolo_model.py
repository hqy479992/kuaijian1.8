...
class YOLO:
    def __init__(self, yolov3_model_path, obj_threshold, nms_threshold):
        """Init.

        # Arguments
            obj_threshold: Float, threshold for object.
            nms_threshold: Float, threshold for box.
        """
        self.obj_threshold = obj_threshold
        self.nms_threshold = nms_threshold
        self._yolo = load_model(yolov3_model_path)
