...
class VideoQueue():
    ...
    def next_frame(self):
        ...
        # other frames
            ...
            if success == False:
                print(self._video_filenames)
                print(self._current_video_cap_point)
                print(self._video_length[self._current_video_number])
                print(self._video_length)
...
class VideoTrack():
    ...
    def next_frame(self):
        ...
        # sliding window size is not 0
            ...
            temp_frame = self._video_queue.next_frame()
            return_frame = self._window_image_list[0]
            self._previous_image = temp_frame
            # print(self._previous_image)
            self._update_window_image_list(temp_frame)
            if temp_frame is None:
                self._window_none_count += 1

            # self._window_image_list.pop(0)
            # self._window_image_list.append(temp_frame)
            ...
            # Null frame has no state
                ...
                # self._window_state_list.pop(0)
                # self._window_state_list.append(None)
    ...
    def _update_window_image_list(self, frame):
        ...
        self._window_image_list.pop(0)
        self._window_image_list.append(frame)
    ...
    def _update_window_state_list(self, state):
        ...
        self._window_state_list.pop(0)
        self._window_state_list.append(state)
        # for i in range(self._window_size - 1):
